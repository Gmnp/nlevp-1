...
X = add_problem(X,'schrodinger_nep', 'nep', 'real', 'scalable', 'sparse', ...
    'parameter_dependent', 'banded', 'tridiagonal');
...
X = add_problem(X, 'time_delay3', 'nep', 'real', 'scalable', 'parameter-dependent');
